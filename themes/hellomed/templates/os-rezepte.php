...
<main>
    <div class="container">
        <div class="hm-content">
            ...
            <div class="h2 mb-5">
                Rezepte
                <img src="https://ui.hellomed.com/src/v1.1/img/icons/onboarding/prescription2.svg">
            </div>
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th>Startdatum</th>
                        <th>Enddatum</th>
                        <th>Enthaltene<br>Medikamente</th>
                        <th>Status</th>
                    </tr>
                </thead>
                <tbody>
...
?>
                    <tr>
                        ...
                        <td data-label="Datum der Verschreibung"><?php echo date("d.m.Y", strtotime($rezept['prescription_date_by_doctor'])); ?></td>
