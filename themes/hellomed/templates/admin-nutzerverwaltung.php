...
<a href="admin-nutzerverwaltung?status=Gefährdet"> <button type="button" class="btn btn-danger">Gefähred</button>
        ...
        ?>
                    <tr>
                        ...
                        if ($patient_caregiver == 'Caregiver') {
                            ...
                            echo "<br><span class=small>Caregiver: ".get_field('caregiver_vorname', 'user_' . $user->ID).' '.get_field('caregiver_nachname', 'user_' . $user->ID). "</span><br>"; 
                            }  
                        else {
                            echo $user_firstname. " ".$user_lastname; 
                             }
                        ...
                        <td  data-label="Status" ><span class="badge rounded-pill text-bg-<?php echo  strtolower($user->status); ?>"><?php echo $user->status; ?></span>
                        </td>
