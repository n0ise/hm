    ...
    public function get_dashboard_menu($submenus,$parent_slug)
    {
        ...
        if($display)
        {
            ...
            if (current_user_can('administrator'))
            {
                ...
                $submenu['capability'] = 'wpvivid-can-use-plugins';
            }
    ...
    public function dashboard_menus_panel()
    {
        ...
        <div id="post-body-content">
            <div class="meta-box-sortables ui-sortable">
                ...
                <?php
                    if(current_user_can('administrator')||current_user_can('wpvivid-can-install-plugins'))
                    {
        ...
        if($show)
        {
            ...
            ?>
                <div class="wpvivid-clear-float">
                    ...
                    <div>
                        <?php
                        if(current_user_can('administrator')||current_user_can('wpvivid-can-backup'))
                        {
                            if($backup)
                            {
                        ...
                        if(current_user_can('administrator')||current_user_can('wpvivid-can-use-schedule'))
                        {
                            if($schedule)
                            {
                        ...
                        if(current_user_can('administrator')||current_user_can('wpvivid-can-mange-backup')||current_user_can('wpvivid-can-mange-local-backup')||current_user_can('wpvivid-can-mange-remote-backup'))
                        {
                            if($backup_list)
                            {
                                ...
                                echo '<div class="wpvivid-two-col wpvivid-dashboard-list">
                                                <span class="dashicons dashicons-editor-ul wpvivid-dashicons-large wpvivid-dashicons-green"></span>
                                                <a href="'.$url.'"><b>Backups & Restore</b></a>
                                                <span style="float: right;"><a href="'.$help_url.'">Learn more...</a></span><br>
                        ...
                        if(current_user_can('administrator')||current_user_can('wpvivid-can-mange-remote'))
                        {
                            if($remote)
                            {
                        ...
                        if(current_user_can('administrator')||current_user_can('wpvivid-can-export-site'))
                        {
                            if($backup)
                            {
                        ...
                        if(current_user_can('administrator')||current_user_can('wpvivid-can-import-site'))
                        {
                            if($backup_list)
                            {
