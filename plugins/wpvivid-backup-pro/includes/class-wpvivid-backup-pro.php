...
class WPvivid_backup_pro
{
    ...
    public function __construct()
    {
        ...
        if(is_admin())
        {
            ...
            if (is_multisite())
            {
                add_action('network_admin_menu',array( $this,'add_dashboard_admin_menu'));
            }
            else
            {
                add_action('admin_menu',array( $this,'add_dashboard_admin_menu'));
            }
    ...
    public function add_dashboard_admin_menu()
    {
        ...
        else
        {
            ...
            if (current_user_can('administrator'))
            {
                ...
                $capability = 'wpvivid-can-use-plugins';
            }
