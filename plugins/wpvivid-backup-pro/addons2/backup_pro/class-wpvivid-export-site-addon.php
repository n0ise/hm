    ...
    public function get_dashboard_menu($submenus,$parent_slug)
    {
        ...
        if($display)
        {
            ...
            if (current_user_can('administrator')) {
                ...
                $submenu['capability'] = 'wpvivid-can-export-site';
            }
    ...
    public function get_toolbar_menus($toolbar_menus)
    {
        ...
        if($display)
        {
            ...
            if (current_user_can('administrator')) {
                ...
                $menu['capability'] = 'wpvivid-can-export-site';
            }
            $menu['index'] = 4;
            ...
            <div class="wpvivid-one-coloum wpvivid-workflow wpvivid-clear-float" id="wpvivid_migration_export_site_success_notice" style="background:#eaf1fe;border-radius:8px; margin-bottom:1em; display: none;">
                ...
                <div style="">
                    <p style="text-align:center;">
                        ...
                        <span><strong>The backup has been sent to your target Wordpress site, you can import it on traget site, <a href="https://docs.wpvivid.com/wpvivid-backup-pro-auto-migration.html" target='_blank'>learn more...</a></strong></span>
                    </p>
                </div>
