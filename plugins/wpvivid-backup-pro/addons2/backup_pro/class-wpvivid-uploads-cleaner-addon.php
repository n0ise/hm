...
class WPvivid_Uploads_Cleaner_addon
{
    ...
    public function get_toolbar_menus($toolbar_menus)
    {
        ...
        if($display)
        {
            ...
            if (current_user_can('administrator'))
            {
                ...
                $menu['capability'] = 'wpvivid-can-use-image-cleaner';
            }
            $menu['index'] = 13;
    ...
    public function get_dashboard_menu($submenus,$parent_slug)
    {
        ...
        if($display)
        {
            ...
            if (current_user_can('administrator'))
            {
                ...
                $submenu['capability'] = 'wpvivid-can-use-image-cleaner';
            }
    ...
    public function setting_tab($tabs){
        if(current_user_can('administrator')||current_user_can('wpvivid-can-use-image-cleaner'))
        {
