...
class WPvivid_Schedule_addon
{
    ...
    public function get_caps($cap_list)
    {
        ...
        $cap['display']='Create backup schedules';
    ...
    public function get_dashboard_menu($submenus,$parent_slug)
    {
        ...
        if($display)
        {
            ...
            if (current_user_can('administrator')) {
                ...
                $submenu['capability'] = 'wpvivid-can-use-schedule';
            }
    ...
    public function get_toolbar_menus($toolbar_menus)
    {
        ...
        if($display) {
            ...
            if (current_user_can('administrator')) {
                ...
                $menu['capability'] = 'wpvivid-can-use-schedule';
            }
            $menu['index'] = 6;
            ...
            <div class="wpvivid-one-coloum wpvivid-workflow wpvivid-clear-float" style="margin-top:1em;">
                ...
                <div style="">
                    ...
                    <div style="padding-left:2em;">
                        ...
                        <?php
                        if(current_user_can('administrator')||current_user_can('wpvivid-can-backup-remote'))
                        {
                            ?>
                            <label class="">
