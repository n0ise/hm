...
class Wpvivid_BackupUploader_addon
{
    public function __construct()
    {
        ...
        add_action('wp_ajax_wpvivid_addon_get_file_id',array($this,'get_file_id'));
    ...
    function restore_upload_backup_ex()
    {
        global $wpvivid_backup_pro;
        $wpvivid_backup_pro->ajax_check_security();
        try{
    ...
    function cancel_upload_backup_addon()
    {
        global $wpvivid_backup_pro;
        $wpvivid_backup_pro->ajax_check_security();
        try{
            ...
            function wpvivid_init_upload_list_ex()
            {
                ...
                function wpvivid_check_plupload_added_files_ex(up,files)
                {
                    if(wpvivid_upload_id_ex==='')
                    {
                        ...
                        var ajax_data = {
                            'action': 'wpvivid_addon_get_file_id',
                            'file_name':file.name
                        };
                        wpvivid_post_request_addon(ajax_data, function (data)
                        {
