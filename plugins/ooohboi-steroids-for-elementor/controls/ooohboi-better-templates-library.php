			...
			switch ( $theme_columns ) {
				case 'featured_thumb':
					if( function_exists( 'the_post_thumbnail' ) ) {
						...
						$remove_thumb = ( ! $thumb ) ? '' : '<em id="ele-btl-delete-media_' . get_the_ID() . '" data-elebtlid="' . get_the_ID() . '" title="' . esc_html__( 'Delete?', 'ooohboi-steroids' ) . '"></em>'; 
						printf( 
							'%4$s<a id="ele-btl-insert-media_%1$s" class="ele-btl-img-link" href="%2$s" data-elebtlid="%1$s"><span></span><img class="ele-btl-img" src="%3$s" alt="%5$s"></a>', 
							get_the_ID(), 
							'#', 
							$img_set, 
							$remove_thumb, 
